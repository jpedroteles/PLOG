...
instructionsMenu:- nl,
        ...
        write(' -If you are unable to deploy a warrior on any battleground, you may place a warrior on any open square.'),nl,
        write(' However, if you can make a valid play, you must make that play.'),nl,nl,
        ...
        write('points to. Start by removing your opponents disks.Then place your disks on the warriors you are raiding.'),nl,
        write('Finally, place your disk on the original warrior you placed.'),nl,nl,
        ...
        write('occupies the warrior. The occupying disk is left behind to mark the victory.'),nl,nl,
        write('**Rule 4 Reinforcements**'),nl,
        write(' Draw a face-down warrior and add it to your hand.'),nl,nl,
        write('**End of Play**'),nl,
        write(' Play ends when no open square remains'),nl,nl,
